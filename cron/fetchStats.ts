...
const getPlayerConnectCodes = async (): Promise<string[]> => {
  return ['KIBS#345', 'KITE#0', 'CSD#497', 'G2W#0', 'RUMP#435', 'JTB#437', 'FIVE#721', 'RYSE#504', 'TWNK#902', 'LOWH#158', 'CANT#504', 'CHCO#192', 'LMAO#249', 'NUT#356', 'JEH#749', 'COLE#860', 'PURO#774', 'CLAR#813', 'ZEIT#699', 'XJ#9', 'M#150', 'ARRYU#0', 'SPEN#172', 'ESQ#644', 'DASH#738', 'KONG#443', 'UNON#266', 'DRG#0', 'VINN#389', 'THIS#283', 'AWOO#233', 'AMPS#207', 'CFR#303', 'ATLA#808', 'SHOO#817', 'BIGS#1', 'LIT#420', 'LAN#459', 'ALEX#414', 'ICAN#307', 'MOO#000', 'SNES#495', 'JMT#0', 'BART#638', 'WOOZ#442', 'FLXX#619', 'LILF#921', 'NEPH#113', 'LORD#533', 'HERT#720', 'POOP#438', 'COFF#960', 'CLAR813', 'JUST#974', 'MAWK#863', 'ZIP#472', 'FREE#666', 'JAMMAN#0', 'CULT#152', 'SOLO#976', 'CFTG#552', 'RAT#530', 'PICK#132', 'FUYO#554', 'KDAK#689', 'RORN#612', 'BYLT#333', 'STIM#833', 'SIM#142', 'POOP#733', 'FLAT#120', 'RAND#133', 'BOOK#691', 'MUH#0', 'GUT#120', 'PANT#212', 'FILT#324', 'LOOS#258', 'RAW#632', 'BEEBZ#96', 'JSP#353', 'MAPL#972', 'BRUS#217'];
};
